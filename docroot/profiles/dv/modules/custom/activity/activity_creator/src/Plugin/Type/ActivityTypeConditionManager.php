 ...
 */
class ActivityTypeConditionManager extends DefaultPluginManager {

  /**
   * Constructor for ActivityTypeConditionManager objects.
   *
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/ActivityTypeCondition', $namespaces, $module_handler, 'Drupal\activity_creator\Plugin\ActivityTypeConditionInterface', 'Drupal\activity_creator\Annotation\ActivityTypeCondition');

    $this->alterInfo('activity_creator_activity_type_condition_info');
    $this->setCacheBackend($cache_backend, 'activity_creator_activity_type_condition_plugins');
  }
