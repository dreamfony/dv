...
/// @todo: make sense if some of these should be required_stats also
/*
const ACTIVITY_STATUS_ANSWERED = 'answered';
const ACTIVITY_STATUS_REJECTED = 'rejected';
const ACTIVITY_STATUS_NOT_HELD = 'not_held';
*/
 ...
 * )
 */
class ActivityWorkflow extends WorkflowTypeBase implements ContainerFactoryPluginInterface {
