 ...
 *
 * @see \Drupal\activity\Entity\ActivityEntity.
 */
class ActivityEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\activity\Entity\ActivityEntityInterface $entity */
    switch ($operation) {
      case 'view':
