...
class AccountHeaderBlock extends BlockBase {
  ...
  public function build() {
    ...
    if ($account->id() !== 0) {
      ...
      // DMT Ovdje sam zakomentirao ovo sve ali ce nam trebati kad napravimo svoj notifications
      /*
...
*/
      $num_notifications = 33; // hardcodiranoo
      ...
      $links['account_box'] = array(
        ...
        'below' => array(
          ...
          'my_account' => array(
            ...
            'title_classes' => '',
            'url' => Url::fromRoute('entity.user.edit_form', ['user' => $account_uid])->toString(),
          ),
          'edit_profile' => array(
            'classes' => '',
            'link_attributes' => '',
            ...
            'title_classes' => '',
            // when we add different profile types 4th parameter is profile id
            'url' => Url::fromRoute('entity.profile.type.profile.user_profile_form', ['user' => $account_uid, 'profile_type' => 'profile'])->toString(),
          ),
          'divide_logout' => array(
            'divider' => 'true',
            'classes' => 'divider',
