...
namespace Drupal\comment_plus\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'comment_plus' field type.
 *
 * @FieldType(
 *   id = "comment_plus",
 *   label = @Translation("Comments Plus"),
 ...
 *   default_formatter = "comment_plus"
 * )
 */
class CommentItemPlus extends CommentItem {
